...
<nav class=" bg-dark navbar-dark">
    <ul class="nav nav-tabs justify-content-center">
        ...
        <li class="nav-item">
            <a class="nav-link <?php if ($activepage === 'recommendations') echo 'active bg-secondary', '' ?> text-white disabled" aria-disabled="true" tabindex="-1" aria-current="page" href="../recommendations.php">Recomendações</a>
        </li>
        <li class="nav-item">
